...
#ifndef THIRD_PARTY_TPU_RAIDEN_API_JAX_DISAGG_KV_CACHE_MANAGER_H_
#define THIRD_PARTY_TPU_RAIDEN_API_JAX_DISAGG_KV_CACHE_MANAGER_H_
...
class DisaggKVCacheManager : public DisaggKVCacheManagerBase {
 public:
  using DisaggKVCacheManagerBase::DisaggKVCacheManagerBase;

  // Standard Python list arrays unpack constructor
...
#endif  // THIRD_PARTY_TPU_RAIDEN_API_JAX_DISAGG_KV_CACHE_MANAGER_H_
