...
// that sub-manager.
TEST(KVCacheManagerWrapperTest, H2hWriteSingleSubManagerForwardsBlocksAndEndpoint) {
  auto sub0 = std::make_unique<MockSubManager>();
  MockSubManager* ptr0 = sub0.get();
  std::vector<std::unique_ptr<KVCacheManagerWithTransfer>> subs;
  subs.push_back(std::move(sub0));
...
TEST(KVCacheManagerWrapperTest, H2hReadSingleSubManagerForwardsBlocksAndEndpoint) {
  auto sub0 = std::make_unique<MockSubManager>();
  MockSubManager* ptr0 = sub0.get();
  std::vector<std::unique_ptr<KVCacheManagerWithTransfer>> subs;
  subs.push_back(std::move(sub0));
