...
class PrometheusExporterTest : public ::testing::Test {
 protected:
  void SetUp() override { unlink("/dev/shm/tpu_raiden_metrics.shm"); }
  void TearDown() override { unlink("/dev/shm/tpu_raiden_metrics.shm"); }
};

TEST_F(PrometheusExporterTest, RecordAndExportFormat) {
...
TEST_F(PrometheusExporterTest, MetricMetadataConstantsMapped) {
...
TEST_F(PrometheusExporterTest, UnmappedMetricIgnored) {
...
TEST_F(PrometheusExporterTest, ConstReferenceAccess) {
  PrometheusExporter exporter;
...
TEST_F(PrometheusExporterTest, ConcurrentMetricUpdates) {
  PrometheusExporter exporter;
