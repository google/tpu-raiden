...
void RaidenMetricStore::SetBackends(
    std::vector<std::unique_ptr<MetricsBackend>>) {}

bool RaidenMetricStore::HasBackends() const {
  return false;
}

void RaidenMetricStore::IncrementCounter(absl::string_view, LabelSpan,
                                         uint64_t) const {}

void RaidenMetricStore::SetGauge(absl::string_view, LabelSpan, double) const {}

void RaidenMetricStore::ObserveHistogram(absl::string_view, LabelSpan,
                                         double) const {}
