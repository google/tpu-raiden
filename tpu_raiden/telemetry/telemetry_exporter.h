...
// Supported implementations include 3P OSS exposition (Prometheus) and
// 1P Google internal infrastructure (Streamz).
class TelemetryExporter {
 public:
  ...
  virtual absl::Status ExportBatch(const MetricBatch& batch) {
